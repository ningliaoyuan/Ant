...
<form>
    <div><label>邮箱/昵称：</label><a href="#">注册新用户</a></div>
    <div><input type="text" class="inp" /></div>
    <div class="warn"><span>&nbsp;!&nbsp;</span>&nbsp;用户昵称或邮箱地址不存在</div>
    <div><label>密码：</label><a href="#">忘记密码了？</a></div>
    <div><input type="password" class="inp" /></div>
    <div class="warn"><span>&nbsp;!&nbsp;</span>&nbsp;密码错误</div>
